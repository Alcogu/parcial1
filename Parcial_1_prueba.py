...
if __name__ == '__main__':
    ...
    #pygame.draw.polygon(pantalla,AZUL, lista1)
    #pygame.draw.polygon(pantalla,ROJO, lista2)
    #pygame.draw.polygon(pantalla,VERDE, lista3)
    #pygame.draw.polygon(pantalla,BLANCO, lista4)
    #pygame.draw.polygon(pantalla,AMARILLO, lista5)
    ...
    #pygame.draw.polygon(pantalla,AMARILLO, iso_e, 2)  
